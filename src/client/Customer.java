...
public class Customer extends User {
    ...
    //Corrected
    public Customer(int ID, String password, String role, String name) {
        super();
    ...
    //Corrected
    public Customer(int ID, String password, String role, String name, double accountBalance, int ui) {
    ...
    //Corrected
    public Customer(int ID, String password, String role, String name, int ui) {
        super(ID, password, role, name);
        this.cust_id = ui;
        // this.User = new User(id, password, role, name);
    ...
    //Corrected
    public Customer(int ID, String password, String role, String name, double accountBalance, int ui, User User) {
        super(ID, password, role, name);
        this.cust_id = ui;
        this.accountBalance = accountBalance;
    ...
    //Corrected
    public Customer read(int id, String pword, Transaction trans) {
